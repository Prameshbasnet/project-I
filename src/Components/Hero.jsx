    ...
    return (
        <section className="h-screen w-full bg-gradient-to-tr from-[#5a6ce6]  via-[#8a92b8]  % to-[#26338A] ">
                ...
                <div className="">
                    <div className="flex justify-center">
                        <div className="grid grid-cols-4 items-center gap-3">
                            <a
                                href="#"
                                className="flex items-center justify-center p-2 gap-3 rounded-full border border-black text-[15px] cursor-pointer sm:text-[20px] sm:justify-around sm:p-1"
                            >
                                <FaStore />
                                Online Store
                            </a>
            ...
            <div className="my-[140px] mx-20">
                ...
                <button className=" mt-16 p-2 gap-3 rounded-full border border-black text-[15px] cursor-pointer items-center justify-center sm:text-[20px] sm:justify-around ">
                    Get Started
                </button>
            </div>
        </section>
